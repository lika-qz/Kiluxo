...
<body class="animsition">
	...
	<div class="container">
		...
		<h2 class="text-center mt-3 mb-5">Cadastre-se</h2>

	   <form action="cadastrar.php" method="post" class="dados mx-auto" style="max-width: 500px;">
			<div class="mb-3">
				<input type="text" class="form-control mt-3" name="nome"  placeholder="Nome">
			</div>
			<div class="mb-3">
				<input type="text" class="form-control mt-3" name="cpf"   placeholder="CPF">
			</div>
			<div class="mb-3">
				<input type="text" class="form-control mt-3" name="telefone"   placeholder="Telefone">
			</div>
			<div class="mb-3">
	   ...
	   <?php
		   if(isset($_POST['nome'], $_POST['cpf'], $_POST['telefone'], $_POST['email'], $_POST['senha'], $_POST['csenha'])){
			   $nome     = $_POST['nome'];
			   $cpf      = $_POST['cpf'];
			...
			<div class="row">
				...
				<div class="col-sm-6 col-lg-3 p-b-50">
					...
					<p class="stext-107 cl7 size-201">
					  Dúvidas? Entre em contato conosco na loja, localizada na Rua da Padre Victor, 680, Tauá Mirim, ou ligue para (97) 98402-9004.					</p>
