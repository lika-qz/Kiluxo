			...
			<div class="tab01">
				...
				<ul class="nav nav-tabs" role="tablist">
					<li class="nav-item p-b-10" role="presentation">
						<a class="nav-link active" data-toggle="tab" href="#best-seller" role="tab" aria-selected="true"
					...
					<li class="nav-item p-b-10" role="presentation">
						<a class="nav-link" data-toggle="tab" href="#featured" role="tab" aria-selected="false"
					...
					<li class="nav-item p-b-10" role="presentation">
						<a class="nav-link" data-toggle="tab" href="#sale" role="tab" aria-selected="false"
							aria-controls="sale">
							Vendas
						</a>
					</li>
					...
					<li class="nav-item p-b-10" role="presentation">
						<a class="nav-link" data-toggle="tab" href="#top-rate" role="tab" aria-selected="false"
							aria-controls="top-rate">
							Melhores taxas
						</a>
					</li>
				</ul>
