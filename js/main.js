...
(function ($) {
    ...
    // Quick View Modal para catálogo e carrinho
    ...
    $('.js-show-modal1').on('click',function(e){
        e.preventDefault();
        // Pega o bloco do produto clicado
        ...
        // Remove todos os slides do slick
        ...
        // Inicializa o slick após inserir o HTML
        setTimeout(function(){
            slick3.slick({
                slidesToShow: 1,
                slidesToScroll: 1,
